...
//Main Text Section
  class StyledText extends StatelessWidget {
    const StyledText({super.key, required this.text, this.fontSize = 16.0, this.fontWeight = FontWeight.normal, this.color = Colors.black});
...
//Card Text Section
  class CardText extends StatelessWidget {
    const CardText({super.key, required this.text, this.fontSize = 16.0, this.fontWeight = FontWeight.normal, this.color = Colors.white});
